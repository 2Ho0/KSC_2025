...
from Decision_Transformer.src.patch_transformer_lens.hooked_transformer_methods import (
    fold_layer_norm,
)
...
def parse_args():
    ...
    parser.add_argument("--trajectory_path", nargs='+', default=['/home/hail/Desktop/Alarm/Decision_Transformer/src/trajectories/DoorKey10937-1.gz','/home/hail/Desktop/Alarm/Decision_Transformer/src/trajectories/LavaCrossing10937.gz','/home/hail/Desktop/Alarm/Decision_Transformer/src/trajectories/SimpleCrossing10937.gz'], type=str)
    ...
    parser.add_argument("--n_ctx", type=int, default=62)
    ...
    parser.add_argument(
        "--scheduler", type=str, default="ConstantWithWarmUp"
    )
    ...
    parser.add_argument("--state_embedding", type=str, default="cnn")
    parser.add_argument(
    ...
    parser.add_argument("--eval_max_time_steps", type=int, default=100)
